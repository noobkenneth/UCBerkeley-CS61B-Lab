...
public class MinHeap<E extends Comparable<E>> {
    ...
    //private void bubbleUp(int index) {
        ...
        //while (hasParent(x)
        //        && contents.get(getParentOf(x)).compareTo(contents.get(x)) > 0) {
...
//            int smallerChildIndex = getLeftOf(index);
//
//            if (hasRightChild(index)
//                    && min(getRightOf(index), getLeftOf(index)) == getRightOf(index)) {
//                smallerChildIndex = getRightOf(index);
//            }
//
//            if (min(x, smallerChildIndex) == smallerChildIndex) {
//                swap(x, smallerChildIndex);
//            } else {
//                break;
//            }
//            x = smallerChildIndex;
...
//   }
    ...
    public void bubbleDown(int index) {
        if (index >= contents.size() || !hasLeftChild(index)) {
            return;
        } else {
            ...
            if (!hasRightChild(index)) {
                ...
                if (min(child, getRightOf(index)) == getRightOf(index)) {
                    child = getRightOf(index);
                    if (min(index, child) == child) {
                        swap(index, child);
                    }
                }
