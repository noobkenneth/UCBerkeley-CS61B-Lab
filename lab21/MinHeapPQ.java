...
public class MinHeapPQ<T> implements PriorityQueue<T> {
    ...
    public void insert(T item, double priority) {
        PriorityItem x = new PriorityItem(item, priority);
        heap.insert(x);
        heap.update(x);
    }
    ...
    public T poll() {
        PriorityItem toReturn = heap.removeMin();
    ...
    public void changePriority(T item, double priority) {
        PriorityItem temp = new PriorityItem(item, priority);
        heap.update(temp);
    }
    ...
    public static void main(String[] args) {
        MinHeapPQ<String> minHeap = new MinHeapPQ<>();
        minHeap.insert("a", 5);
        minHeap.insert("b", 2);
        minHeap.insert("c", 3);
        minHeap.insert("d", 1);
        //minHeap.insert("e", 2);
        //minHeap.changePriority("a",1);
        minHeap.changePriority("d", 2);
